        ...
        <Container maxW="4xl" as="main">
          <article>
            <VStack spacing={8} align="stretch">
              ...
              <Heading as="h2" size="lg" mb={6} mt={10} color={headingColor} borderBottom="3px solid" borderColor={useColorModeValue("purple.200", "purple.600")} pb={3}>A Gateway to Pain</Heading>
              ...
              <Heading as="h2" size="lg" mb={6} mt={10} color={headingColor} borderBottom="3px solid" borderColor={useColorModeValue("purple.200", "purple.600")} pb={3}>Cenobites in the Flesh</Heading>
              ...
              <Heading as="h2" size="lg" mb={6} mt={10} color={headingColor} borderBottom="3px solid" borderColor={useColorModeValue("purple.200", "purple.600")} pb={3}>Did You Know it was a Book First?</Heading>
              ...
              <Heading as="h2" size="lg" mb={6} mt={10} color={headingColor} borderBottom="3px solid" borderColor={useColorModeValue("purple.200", "purple.600")} pb={3}>Legacy of Body Horror</Heading>
              ...
              <Heading as="h2" size="lg" mb={6} mt={10} color={headingColor} borderBottom="3px solid" borderColor={useColorModeValue("purple.200", "purple.600")} pb={3}>Unearthly Symphony of Pain</Heading>
