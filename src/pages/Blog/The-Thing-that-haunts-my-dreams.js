...
export default function Thing() {
  return (
    <Container>
      <Stack>
        <Heading as="h1">The Thing that Haunts my Dreams</Heading>
        ...
        <Heading size="md" as="h3">Cultural Impact</Heading>
        <Text>
        ...
        <Heading size="md" as="h3">Legacy in Horror Cinema</Heading>
        <Text>
        ...
        <Heading size="md" as="h3">Cult Following and Homages</Heading>
        <Text>
        ...
        <Heading size="md" as="h3">A Frozen Classic</Heading>
        <Text>
