...
export default function Psycho() {
  return (
    <div>
      <Container>
        <Heading>Psycho, the ultimate classic</Heading>
        <Text>
          ...
          <Heading>The Power of Hitchcock's Psycho</Heading>
          ...
          <Heading>The Psycho Legacy</Heading>
          ...
          <Heading>Cultural Impact and Subversion</Heading>
          ...
          <Heading>The Psycho Effect on Popular Culture</Heading>
          ...
          <Heading>A Timeless Terror</Heading>
