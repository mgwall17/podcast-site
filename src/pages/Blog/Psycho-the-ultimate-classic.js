...
export default function Psycho() {
  return (
    <Container>
      <Stack>
        <Heading as="h1">Psycho, the Ultimate Classic</Heading>
        ...
        <Heading size="md" as="h3">The Psycho Legacy</Heading>
        <Text>
        ...
        <Heading size="md" as="h3">Cultural Impact and Subversion</Heading>
        <Text>
        ...
        <Heading size="md" as="h3">The Psycho Effect on Popular Culture</Heading>
        <Text>
        ...
        <Heading size="md" as="h3">A Timeless Terror</Heading>
        <Text>
